...
- **Blueprint forge** — one forge, every realm, no local copies (KP ⚛
  ...
  declared — never hand-draw a tree):
      ...
      python c:/_superposition/resonance-ziggy/tend.py forge run --root c:/_superposition/resonance-papers
...
- **Link tender** — every markdown pointer in this realm, both house shapes,
  ...
  read the report before mending:
      ...
      python c:/_superposition/resonance-ziggy/tend.py links dry --root c:/_superposition/resonance-papers
      python c:/_superposition/resonance-ziggy/tend.py links mend --root c:/_superposition/resonance-papers
